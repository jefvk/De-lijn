               ...
               if (err) {
                 ...
                 request.get({url:getCoorNaar, json:true}, (err,res,data)=>{
                   if (err) {
                     ...
                     var finalUrl = 'https://www.delijn.be/rise-api-core/reisadvies/routes/'+ req.body.Van + '/' +req.body.Naar +'/'+xVan+'/'+yVan+'/'+xNaar+'/'+yNaar+'/'+req.body.kalender+'/'+req.body.tijdstip+'/1/on/of/of/of/of/nl';
